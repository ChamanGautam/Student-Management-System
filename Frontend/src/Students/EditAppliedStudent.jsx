...
const EditAppliedStudent = () => {
    ...
    let getappliedStudent = async () => {
        let result = await fetch(`http://127.0.0.1:4500/studentapplieddata/${params.id}`);
        result = await result.json();
        setName(result.name); setEmail(result.email); setContact(result.contact);  setCourse(result.course); setCity(result.city); 
    }
    useEffect(() => {
        getappliedStudent();
    }, []);

    let updateappliedStudent = async () => {
        let result = await fetch(`http://localhost:4500/updateapplystudent/${params.id}`, {
            method: 'put',
        ...
        <div>
            ...
            <div className="edit-base">
                <div className="edit-main">
                    ...
                    <button className="editbtn" onClick={updateappliedStudent}>Update</button>
                </div>
            </div>
        </div>
    );
...
export default EditAppliedStudent;